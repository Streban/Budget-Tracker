...
// Savings Trackers API
export const savingsTrackersApi = {
  getAll: () => fetchData<SavingsTracker>("savings-trackers"),
  save: (data: SavingsTracker[]) => saveData("savings-trackers", data),
}
